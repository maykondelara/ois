...
async function main() {
  await Promise.all([
    ...
    import("../src/app/api/companies/[companyId]/files/route"),
    import("../src/app/api/companies/[companyId]/files/[fileId]/finalize/route"),
    import("../src/app/api/companies/[companyId]/files/[fileId]/download/route"),
